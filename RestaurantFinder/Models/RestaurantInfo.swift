...
extension RestaurantInfo {
    static let sampleData: [RestaurantInfo] =
    [
        RestaurantInfo(name: "Baskeri & Basso", imageURL: "https://media-cdn.tripadvisor.com/media/photo-l/0f/bf/92/0c/salmon-carpaccio.jpg", url: "https://basbas.fi/",  rating: 4, description: "Pago Restaurant is a new dining experience concept serving authentic Indonesian, Asian and Western specialties. Open for breakfast, lunch, and dinner, this restaurant offers extensive buffet and a la carte options.", address: "Ulappakatu 3, Espoo", priceLevel: 4, coordinate: CLLocationCoordinate2D(latitude: 60.157803, longitude: 24.934328), city: "Helsinki", email: "bas@bas.fi", phone: "0504673400", ranking: "no ranking"),
        /*
